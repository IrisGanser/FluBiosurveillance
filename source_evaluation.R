...
met_ind$HM_total_cat2 <- cut(met_ind$HM_total, 
                             breaks = quantile(met_ind$HM_total, probs = seq(0, 1, 0.2)),  
                             include.lowest = TRUE, labels = 1:5)
met_ind$EIOS_total_cat <- ordered(met_ind$EIOS_total_cat, levels = c("low", "medium","high"))
met_ind$EIOS_total_cat2 <- cut(met_ind$EIOS_total, 
                             breaks = quantile(met_ind$EIOS_total, probs = seq(0, 1, 0.2)),  
                             include.lowest = TRUE, labels = 1:5)
met_ind$EngSpan <- ifelse(met_ind$language %in% c("English", "Spanish"), TRUE, FALSE)

my_colors <- brewer.pal(7, "Blues")[3:7]
...
ggplot(metrics_HM, aes(x = false_alarm_rate, y = frac_prevented)) + 
  ...
  scale_y_continuous(limits = c(0, 1)) + 
  scale_color_manual(values = my_colors, labels = 1:5)
ggsave("D:/Dokumente (D)/McGill/Thesis/SurveillanceData/data_epidemic/HM_time_vs_FAR_counts_quintiles.jpeg")
...
ggplot(metrics_EIOS, aes(x = false_alarm_rate, y = frac_prevented)) + 
  ...
  scale_y_continuous(limits = c(0, 1)) +
  scale_color_manual(values = my_colors, labels = 1:5)
#ggsave("D:/Dokumente (D)/McGill/Thesis/SurveillanceData/data_epidemic/EIOS_time_vs_FAR_counts_quintiles.jpeg")
...
p5 <- ggplot(metrics_HM, aes(x = log(HM_total), y = frac_prevented)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Log(Total event counts over 6 years)", y = "") + 
  scale_y_continuous(limits = c(0, 1)) 

p6 <- ggplot(metrics_HM, aes(x = log(HM_max), y = frac_prevented)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Log(Maximum event counts per week)", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p7 <- ggplot(metrics_HM, aes(x = HDI.2018, y = frac_prevented)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Human Development Index", y = "timeliness (prevented fraction)") + 
  scale_y_continuous(limits = c(0, 1))

p8 <- ggplot(metrics_HM, aes(x = PFI.2018, y = frac_prevented)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Press Freedom Index", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p9 <- ggplot(metrics_HM, aes(x = TIU.2017, y = frac_prevented)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))


grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "HealthMap timeliness predictors")
ggsave(plot = grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "HealthMap timeliness predictors"),
...
p5 <- ggplot(metrics_HM, aes(x = log(HM_total), y = sens_per_outbreak)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Log(Total event counts over 6 years)", y = "") + 
  scale_y_continuous(limits = c(0, 1)) 

p6 <- ggplot(metrics_HM, aes(x = log(HM_max), y = sens_per_outbreak)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Log(Maximum event counts per week)", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p7 <- ggplot(metrics_HM, aes(x = HDI.2018, y = sens_per_outbreak)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Human Development Index", y = "outbreak sensitivity") + 
  scale_y_continuous(limits = c(0, 1))

p8 <- ggplot(metrics_HM, aes(x = PFI.2018, y = sens_per_outbreak)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Press Freedom Index", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p9 <- ggplot(metrics_HM, aes(x = TIU.2017, y = sens_per_outbreak)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))


grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "HealthMap outbreak sensitivity predictors")
...
p5 <- ggplot(metrics_HM, aes(x = log(HM_total), y = sens_exact)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Log(Total event counts over 6 years)", y = "") + 
  scale_y_continuous(limits = c(0, 1)) 

p6 <- ggplot(metrics_HM, aes(x = log(HM_max), y = sens_exact)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) +
  labs(x = "Log(Maximum event counts per week)", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p7 <- ggplot(metrics_HM, aes(x = HDI.2018, y = sens_exact)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Human Development Index", y = "outbreak sensitivity") + 
  scale_y_continuous(limits = c(0, 1))

p8 <- ggplot(metrics_HM, aes(x = PFI.2018, y = sens_exact)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Press Freedom Index", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p9 <- ggplot(metrics_HM, aes(x = TIU.2017, y = sens_exact)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))
...
p5 <- ggplot(metrics_HM, aes(x = log(HM_total), y = specificity)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) +
  labs(x = "Log(Total event counts over 6 years)", y = "") + 
  scale_y_continuous(limits = c(0, 1)) 

p6 <- ggplot(metrics_HM, aes(x = log(HM_max), y = specificity)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Log(Maximum event counts per week)", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p7 <- ggplot(metrics_HM, aes(x = HDI.2018, y = specificity)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Human Development Index", y = "specificity") + 
  scale_y_continuous(limits = c(0, 1))

p8 <- ggplot(metrics_HM, aes(x = PFI.2018, y = specificity)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Press Freedom Index", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p9 <- ggplot(metrics_HM, aes(x = TIU.2017, y = specificity)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))

grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "HealthMap specificity predictors")
ggsave(plot = grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "HealthMap specificity predictors"),
...
p5 <- ggplot(metrics_HM, aes(x = log(HM_total), y = PPV)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) +
  labs(x = "Log(Total event counts over 6 years)", y = "") + 
  scale_y_continuous(limits = c(0, 1)) 

p6 <- ggplot(metrics_HM, aes(x = log(HM_max), y = PPV)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) +
  labs(x = "Log(Maximum event counts per week)", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p7 <- ggplot(metrics_HM, aes(x = HDI.2018, y = PPV)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Human Development Index", y = "positive predictive value") + 
  scale_y_continuous(limits = c(0, 1))

p8 <- ggplot(metrics_HM, aes(x = PFI.2018, y = PPV)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Press Freedom Index", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p9 <- ggplot(metrics_HM, aes(x = TIU.2017, y = PPV)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))


grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "HealthMap positive predictive value predictors")
ggsave(plot = grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "HealthMap positive predictive value predictors"),
...
p7 <- ggplot(metrics_EIOS, aes(x = HDI.2018, y = frac_prevented)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Human Development Index", y = "timeliness (prevented fraction)") + 
  scale_y_continuous(limits = c(0, 1))

p8 <- ggplot(metrics_EIOS, aes(x = PFI.2018, y = frac_prevented)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Press Freedom Index", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p9 <- ggplot(metrics_EIOS, aes(x = TIU.2017, y = frac_prevented)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))


grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "EIOS timeliness predictors")
ggsave(plot = grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "EIOS timeliness predictors"),
...
p7 <- ggplot(metrics_EIOS, aes(x = HDI.2018, y = sens_per_outbreak)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Human Development Index", y = "outbreak sensitivity") + 
  scale_y_continuous(limits = c(0, 1))

p8 <- ggplot(metrics_EIOS, aes(x = PFI.2018, y = sens_per_outbreak)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Press Freedom Index", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p9 <- ggplot(metrics_EIOS, aes(x = TIU.2017, y = sens_per_outbreak)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))


grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "EIOS outbreak sensitivity predictors")
...
p9 <- ggplot(metrics_EIOS, aes(x = TIU.2017, y = sens_exact)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))
...
p7 <- ggplot(metrics_EIOS, aes(x = HDI.2018, y = specificity)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Human Development Index", y = "specificity") + 
  scale_y_continuous(limits = c(0, 1))

p8 <- ggplot(metrics_EIOS, aes(x = PFI.2018, y = specificity)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Press Freedom Index", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p9 <- ggplot(metrics_EIOS, aes(x = TIU.2017, y = specificity)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))

grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "EIOS specificity predictors")
ggsave(plot = grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "EIOS specificity predictors"),
...
p7 <- ggplot(metrics_EIOS, aes(x = HDI.2018, y = PPV)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Human Development Index", y = "positive predictive value") + 
  scale_y_continuous(limits = c(0, 1))

p8 <- ggplot(metrics_EIOS, aes(x = PFI.2018, y = PPV)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Press Freedom Index", y = "") + 
  scale_y_continuous(limits = c(0, 1))

p9 <- ggplot(metrics_EIOS, aes(x = TIU.2017, y = PPV)) + 
  geom_jitter(size = 2, width = 0.1, height = 0) + 
  labs(x = "Total percentage of internet users", y = "") + 
  scale_y_continuous(limits = c(0, 1))


grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "EIOS positive predictive value predictors")
ggsave(plot = grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, ncol = 3, top = "EIOS positive predictive value predictors"),
